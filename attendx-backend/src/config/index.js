...
module.exports = {
  ...
  cors: {
    origins: process.env.CORS_ORIGINS?.split(',') || ['http://localhost:3000', 'http://localhost:5000']
  },
  ...
  session: {
    ...
    defaultDurationMinutes: parseInt(process.env.SESSION_DEFAULT_DURATION_MINUTES || '90')
  },
